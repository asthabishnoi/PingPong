function onBodyLoad(){
    ...
    document.addEventListener("keydown",function(event){
    	if(event.which == 87 ){
    		if( table.getBoundingClientRect().top != one.getBoundingClientRect().top)
    			one.style.top = one.getBoundingClientRect().top - 92.50 + "px";
    	}
    		...
    		if( table.getBoundingClientRect().top != two.getBoundingClientRect().top)
    			two.style.top = two.getBoundingClientRect().top - 92.50 + "px";
    	}
    ...
    function move(){
    	...
    	if(oneb.getBoundingClientRect().right > ballb.getBoundingClientRect().left){
    		console.log("3a");
    		if(ballb.getBoundingClientRect().top + 40 > oneb.getBoundingClientRect().top && ballb.getBoundingClientRect().bottom - 40 < oneb.getBoundingClientRect().bottom){
    			x = x*(-1);
    			console.log("3");
    		}
    		else{
    		...
    		console.log("4a");
    		if(ballb.getBoundingClientRect().top + 40 > twob.getBoundingClientRect().top && ballb.getBoundingClientRect().bottom - 40 < twob.getBoundingClientRect().bottom){
    			x = x*(-1);
    			console.log("4");
    		}
    		else{
